...
class AuthController extends BaseController
{
    ...
    public function processLogin()
    {
        ...
        // Configuración de las reglas de validación del formulario.
        $rules = [
            'Correo' => 'required|valid_email', // El correo es obligatorio y debe ser válido.
        ...
        $userModel = new UserModel();
        $user = $userModel->findByEmail($this->request->getPost('Correo')); // Buscamos al usuario por su correo.
        ...
        if ($user && password_verify($this->request->getPost('password'), $user['password'])) {
            ...
            $session->set([
                ...
                'Correo' => $user['Correo'],     // Correo del usuario.
