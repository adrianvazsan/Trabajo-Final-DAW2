  ...
  $(document).ready(function () {
    ...
    if (title) {
        $.ajax({
            ...
            type: "POST",
            data: {
                title: title,  // ← Ahora se toma del prompt
                start_date: info.startStr,
                end_date: info.endStr,
                description_eng: "Sin descripción"
            },
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    alert("Error al agregar evento: " + (response.error || "Error desconocido"));
                }
            },
            error: function(xhr) {
                console.error("Error en la solicitud AJAX:", xhr.responseText);
                alert("Error al agregar evento: " + xhr.responseText);
            }
        });
    }
},
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            alert("Error al eliminar el evento: " + response.error);
                        }
                    },
                    error: function (xhr, status, error) {
