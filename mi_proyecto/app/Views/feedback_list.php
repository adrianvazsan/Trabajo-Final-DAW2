			...
			<div class="page d-flex flex-row flex-column-fluid">
					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link" href="<?= base_url('login') ?>">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <a href="<?= base_url('feedback/save') ?>" class="btn btn-primary mb-3">
                        <i class="fas fa-plus"></i> Crear Feedback
                    </a>

                    <!--begin::Search-->
                    <form method="get" action="<?= base_url('feedback') ?>" class="d-flex mb-3">
                        <input type="text" name="search" class="form-control form-control-solid w-250px ps-15 me-2" placeholder="Buscar Feedbacks" value="<?= esc($filters['search'] ?? '') ?>" />
                        <button type="submit" class="btn btn-primary btn-sm me-2">Filtrar</button>
                        <a href="<?= base_url('feedback') ?>" class="btn btn-secondary btn-sm">Limpiar</a>
                    </form>
                    <!--end::Search-->
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
								...
								<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
									...
									<th class="min-w-125px">
										<a href="<?= base_url('feedback?sort=name&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Nombre</a>
									</th>
									<th class="min-w-125px">
										<a href="<?= base_url('feedback?sort=text&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Texto</a>
									</th>
									<th class="min-w-125px">
										<a href="<?= base_url('feedback?sort=rating&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Calificación</a>
									</th>
									<th class="min-w-125px">
										<a href="<?= base_url('feedback?sort=created_at&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Fecha de creación</a>
									</th>
                    ...
                    <?php else: ?>
                        <p class="text-center text-muted">No hay feedbacks registrados.</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
