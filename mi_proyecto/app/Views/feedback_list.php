                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
								...
								<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
									<th class="min-w-125px">
										<a href="<?= base_url('feedback?sort=id&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">ID</a>
									</th>
									<th class="min-w-125px">
										<a href="<?= base_url('feedback?sort=name&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Name</a>
									</th>
									<th class="min-w-125px">
										<a href="<?= base_url('feedback?sort=text&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Text</a>
									</th>
									<th class="min-w-125px">
										<a href="<?= base_url('feedback?sort=rating&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Rating</a>
									</th>
									<th class="min-w-125px">
										<a href="<?= base_url('feedback?sort=created_at&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Date of creation</a>
									</th>
