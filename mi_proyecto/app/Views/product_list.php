													...
													<div class="table-responsive">
														<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
															...
															<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
																...
																<th class="min-w-125px">
																	<a href="<?= base_url('products?sort=product_name&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Nombre del Producto</a>
																</th>
																<th class="min-w-125px">
																	<a href="<?= base_url('products?sort=amount&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Cantidad</a>
																</th>
																<th class="min-w-125px">
																	<a href="<?= base_url('products?sort=origin_product&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Origen del Producto</a>
																</th>
																<th class="min-w-125px">
																	<a href="<?= base_url('products?sort=type_product&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Tipo de Producto</a>
																</th>
																<th class="min-w-125px">
																	<a href="<?= base_url('products?sort=created_at&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Fecha de creación</a>
																</th>
																...
																<div class="d-flex me-2">
																	<form method="get" action="<?= base_url('products') ?>">
																		...
																		<a href="<?= base_url('products') ?>" class="btn btn-secondary btn-sm">Limpiar</a>
																	</form>
																</div>
																</tr>
															</thead>
