					...
					<!--begin::Content-->
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
													...
													<div class="px-7 py-5">
														...
														<div class="mb-10">
															...
															<select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-customer-table-filter="month" data-dropdown-parent="#kt-toolbar-filter">
																...
																<option value="typ">Product Type</option>
																<option value="cre">Date of creation</option>
															</select>
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														...
														<div class="d-flex me-2">
															<form method="get" action="<?= base_url('products') ?>">
																...
																<a href="<?= base_url('products') ?>" class="btn btn-secondary btn-sm">Clear</a>
															</form>
														</div>
														<!--end::Input group-->
														<!--begin::Actions-->
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?= base_url('products/export') ?>" class="btn btn-primary">Export</a>
												<!--end::Add customer-->
											</div>
											<!--end::Toolbar-->
											<!--begin::Group actions-->
