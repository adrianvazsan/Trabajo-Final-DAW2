	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active" href="<?= base_url('grafica') ?>">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
							...
							<!--begin::Container-->
														...
														<div class="card-body d-flex flex-column p-0">
															...
															<div class="flex-grow-1 card-p pb-0">
																<div class="d-flex flex-stack flex-wrap">
																	<div class="me-2">
																		<a href="#" class="text-dark text-hover-primary fw-bolder fs-3">Registered Users</a>
																		<div class="text-muted fs-7 fw-bold">Total users on the platform</div>
																	</div>
																	<div class="fw-bolder fs-3 text-primary"><?= $totalUsers; ?></div>
																</div>
															</div>
															<!--end::Stats-->
															<!--begin::Chart-->
													...
													<div class="card card-xxl-stretch-50 mb-5 mb-xl-8">
														...
														<div class="card-body d-flex flex-column p-0">
															...
															<div class="flex-grow-1 card-p pb-0">
																<div class="d-flex flex-stack flex-wrap">
																	<div class="me-2">
																		<a href="#" class="text-dark text-hover-primary fw-bolder fs-3">Registered Products</a>
																		<div class="text-muted fs-7 fw-bold">Total products on the platform</div>
																	</div>
																	<div class="fw-bolder fs-3 text-primary"><?= $totalProducts; ?></div>
																</div>
															</div>
															<!--end::Stats-->
															<!--begin::Chart-->
									...
									<div class="col-xxl-4">
										...
										<div class="card card-xxl-stretch-50 mb-5 mb-xl-8">
										<!--begin::Body-->
											<div class="card-body p-0 d-flex justify-content-betw flex-column overflow-hidden">
												<!--begin::Hidden-->
												<div class="d-flex flex-stack flex-wrap flex-grow-1 px-9 pt-9 pb-3">
													<div class="me-2">
														<span class="fw-bolder text-gray-800 d-block fs-3">Profits from our coffee</span>
														<span class="text-gray-400 fw-bold"> Jan 15 - Mar 10 25</span>
													</div>
													<div class="fw-bolder fs-3 text-primary">$50,000</div>
												</div>
												<!--end::Hidden-->
												<!--begin::Chart-->
												...
												<!--begin::Hidden-->
																...
																<div class="card-body">
																	...
																	<div class="d-flex justify-content-between align-items-center">
																		<div>
																			<h4 class="fw-bold text-primary">Product Inventory</h4>
																			<small class="text-muted">Quantity available</small>
																		</div>
																	</div>
		...
		<script>
			$(document).ready(function () {
				$.ajax({
					url: "http://localhost/mi_proyecto/public/grafica/datos", // Ajusta según tu configuración
					method: "GET",
					dataType: "json",
					success: function (response) {
						// Extraer nombres de productos y cantidades
						let productNames = response.map(item => item.product_name);
						let amounts = response.map(item => parseInt(item.amount));

						// Configuración de la gráfica
						let options = {
							chart: { type: "bar", height: 350 },
							series: [{ name: "Cantidad", data: amounts }],
