					...
					<!--begin::Content-->
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
													...
													<div class="px-7 py-5">
														...
														<div class="mb-10">
															<!--begin::Label-->
															<label class="form-label fs-5 fw-bold mb-3">Columna</label>
															<!--end::Label-->
															<!--begin::Input-->
															<select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-customer-table-filter="month" data-dropdown-parent="#kt-toolbar-filter">
																...
																<option value="Tle">Telefono</option>
														...
														<div class="d-flex me-2">
																<form method="get" action="<?= base_url('users') ?>">
																	<input type="text" name="search" class="form-control form-control-solid w-250px ps-15 me-3" placeholder="Search Customers" value="<?= esc($filters['search'] ?? '') ?>" />
																		<button type="submit" class="btn btn-primary btn-sm me-3">Filtrar</button>
									...
									<!--begin::Card body-->
											...
											<?php if (session()->getFlashdata('success')): ?>
												<script>
													toastr.success('<?= session()->getFlashdata('success'); ?>', '', { positionClass: 'toast-top-right' });
												</script>
											<?php endif; ?>
													...
													<thead>
															<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
																<th class="min-w-125px">
																	<a href="<?= base_url('users?sort=id&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">ID</a>
																</th>
																<th class="min-w-125px">
																	<a href="<?= base_url('users?sort=name&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Nombre</a>
																</th>
																<th class="min-w-125px">
																	<a href="<?= base_url('users?sort=email&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Email</a>
																</th>
																<th class="min-w-125px">
																	<a href="<?= base_url('users?sort=number_phone&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Teléfono</a>
																</th>
																<th class="min-w-125px">
																	<a href="<?= base_url('users?sort=address&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Dirección</a>
																</th>
																<th class="min-w-125px">
																	<a href="<?= base_url('users?sort=password&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Contraseña</a>
																</th>
																<th class="min-w-125px">
																	<a href="<?= base_url('users?sort=created_at&order=' . ($order === 'asc' ? 'desc' : 'asc')) ?>">Fecha de creación</a>
																</th>
														...
														<?php foreach ($users as $user): ?>
															<tr>
																...
																<td class="text-center">
																	...
																	onclick="return confirm('¿Estás seguro de archivar este usuario?');">
