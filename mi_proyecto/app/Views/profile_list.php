				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								<!--begin::Details-->
								<div class="d-flex align-items-center flex-wrap mr-2 gap-3">
									<h5 class="text-dark font-weight-bold mt-2 mb-2">Edit User:</h5>
									<div class="subheader-separator subheader-separator-ver mt-2 mb-2 bg-gray-200"></div>
									<h5 class="text-dark font-weight-bold mt-2 mb-2"><?= esc($user_name) ?></h5>
								</div>
									...
									<div class="card-body">
										<form class="form" id="kt_form">
											<div class="tab-content">
												...
												<form action="<?= base_url('profiles/saveUser') ?>" method="post">
													<div class="tab-pane show active px-7" id="kt_user_edit_tab_1" role="tabpanel">
														<div class="row">
																	...
																	<div class="col-9">
																		<div class="input-group input-group-lg input-group-solid">
																			...
																			<input type="text" class="form-control form-control-lg form-control-solid" 
																				name="number_phone" value="<?= esc($user_phone) ?>" placeholder="Phone" required />
																		</div>
																	</div>
																</div>
																	...
																	<div class="col-9">
																		<div class="input-group input-group-lg input-group-solid">
																			...
																			<input type="email" class="form-control form-control-lg form-control-solid" 
																				name="email" value="<?= esc($user_email) ?>" placeholder="Email" required />
																		</div>
																	</div>
																</div>
